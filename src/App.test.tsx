...
import type { DiagnosticLogState, KeepAliveState, MailboxState, RuntimeProgress, RuntimeSettings, RuntimeSettingsUpdate, RuntimeState, ShizukuState, StorageAccessState } from './platform/types'
 ...
 */
const unavailableMailbox: MailboxState = {
...
const availableMailbox: MailboxState = {
  ...unavailableMailbox,
